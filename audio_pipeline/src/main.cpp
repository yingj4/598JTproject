...
void CAmbisonicProcessor::ShelfFilterOrder(CBFormat* pBFSrcDst, unsigned nSamples)
{
    ...
    std::cout << "size of m_pFFT_psych_cfg" << sizeof(kiss_fftr_state) << std::endl;
    std::cout << "size of m_pIFFT_psych_cfg" << sizeof(kiss_fftr_state) << std::endl;
                                     ...
                                     float** ppfDst)
{
    ...
    std::cout << "size of m_pFFT_cfg" << sizeof(kiss_fftr_state) << std::endl;
    std::cout << "size of m_pIFFT_cfg" << sizeof(kiss_fftr_state) << std::endl;
